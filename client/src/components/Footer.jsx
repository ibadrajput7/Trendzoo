        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/trendzo.pk?stkn=MWE1aGt0a245ZjVjYQ==" className="w-8 h-8 rounded-full bg-pink-100 dark:bg-pink-900/30 text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                <InstagramIcon />
              </a>
