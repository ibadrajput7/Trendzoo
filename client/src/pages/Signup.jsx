    ...
    <div className="flex min-h-[calc(100vh-80px)] items-center justify-center p-4">
      ...
      >
        <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white/50 p-6 sm:p-8 shadow-2xl backdrop-blur-xl dark:border-gray-800 dark:bg-gray-900/50">
          ...
          <div className="absolute -top-32 -right-32 h-64 w-64 rounded-full bg-primary/20 blur-3xl"></div>
          <div className="absolute -bottom-32 -left-32 h-64 w-64 rounded-full bg-pink-500/20 blur-3xl"></div>
          ...
          <div className="relative z-10">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">Join as an administrator</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="group relative mt-2 flex w-full items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-r from-primary to-pink-500 hover:from-primary-hover hover:to-pink-600 px-8 py-3.5 font-bold text-white transition-all duration-300 disabled:opacity-70 shadow-xl shadow-primary/30"
              >
                {isLoading ? (
            ...
            <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link to="/login" className="font-semibold text-primary transition-colors hover:text-primary-hover dark:text-primary">
                Login here
              </Link>
            </p>
          </div>
